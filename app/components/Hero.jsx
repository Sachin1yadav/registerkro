              ...
              <form className="w-full   max-w-lg md:max-w-md lg:max-w-sm flex flex-col gap-[10px]  p-[10px] rounded-md    ">
                <div className="flex flex-col items-start">
                  ...
                  <input
                    ...
                    className=" border border-[#D0D5DD]  text-[#667085] text-[12px] rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                </div>
                <div className="flex flex-col items-start">
                  <label
                ...
                <button
                  type="submit"
                  className="text-white text-[14px] font-[700] bg-[#3424C2] hover:bg-[#3021b7] focus:ring-4 focus:outline-none focus:ring-blue-300  rounded-md   w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
